...
func (m *MockA2billingRepository) GetAgentIdsByParentAgentID(id int32) ([]int32, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAgentIdsByParentAgentID", id)
	ret0, _ := ret[0].([]int32)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockA2billingRepositoryMockRecorder) GetAgentIdsByParentAgentID(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAgentIdsByParentAgentID", reflect.TypeOf((*MockA2billingRepository)(nil).GetAgentIdsByParentAgentID), id)
}
